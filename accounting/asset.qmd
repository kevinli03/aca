...
Thus, we need to account for the changes in inventory between 31 December (Year End) and 3rd January (Count Date) to accurately determine the contents of the inventory on the year end. The adjustment in **quantity** is as follows:

+---------------------------------------------------+---------------+
| \# of goods: count date                           | X             |
|                                                   |               |
| (less) \# of goods received: between              | \(X\)         |
|                                                   |               |
| \# of goods sold: between                         | X             |
|                                                   |               |
| (less) \# of goods returned by customers: between | \(X\)         |
+---------------------------------------------------+---------------+
| **Adjustment to Inventory Count**                 | X/(X)         |
+---------------------------------------------------+---------------+

: {.bordered .sm tbl-colwidths="\[50,50\]"}

Note: between refers to the period between count date and the year-end.
...
Inventory can be valued in two main ways:

+--------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------+
| **Cost (most common)**         | -   Inventory is valued at the cost of which the inventory was obtained.                                                                           | -   Ex. I bought inventory for £500, with a £50 delivery fee.                                                                    |
...
+--------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------+
| **Net Realisable Value (NRV)** | -   Inventory is valued at the price it can be sold at.                                                                                            | -   Ex. the inventory I have can be sold on the market at £500. I will need to make some modifications of £50 to make this sale. |
...
On the balance sheet, [inventory should be valued at the **lower** of either cost valuation or NRV valuation]{.mark}. This valuation at the lower of either cost or NRV occurs on a product by product basis.

<br />

### Valuation Methods

There are 3 main ways of valuing inventory based on cost (however, LIFO is not allowed under standards).

+-------------------------------+---------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **First in First Out (FIFO)** | When you sell X \# of products, you are selling the goods that you purchased first (the oldest).              | Since you are selling the inventory you purchased first, the closing inventory is mostly the products you purchased last. Thus, valuation is more based on the later purchase prices.              |
+-------------------------------+---------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Average Cost (AVCO)**       | When you sell X \# of products, you are selling X randomly selected products from what you have in inventory. | Since you are selling a random amount of products, we value the closing inventory as some sort of weighted average of purchase prices.                                                             |
+-------------------------------+---------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Last in First Out (LIFO)**  | When you sell X \# of products, you are selling the inventory that you purchased last (most recent).          | Since you are selling the inventory you purchased last, the closing inventory is the products you purchased first. Thus, valuation is more based on the older (possibly outdated) purchase prices. |
+-------------------------------+---------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

: {.bordered .sm tbl-colwidths="\[20,40,40\]"}

LIFO is not allowed under IFRS standards, because it often revolves around valuaing inventory on outdated old prices. This means that it will underestimate the closing inventory (if assuming inflation).
...
+---------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Purchase Cost**   | The cost at which the non-current asset was purchased.                                                                                                                                                |
+---------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Useful Life**     | The amount of time that the NCA can be expected used to generate revenues.                                                                                                                            |
+---------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Residual Value**  | After the useful life of the NCA has passed, what will the remaining NCA be able to be sold for?                                                                                                      |
+---------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Carrying Amount** | The carrying amount is the value of the NCA minus all the previous depreciation expenses incurred on it. **In balance sheet, Carrying Amount is displayed for NCA (basically net value of the NCA)**. |
+---------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
After calculating the annual depreciation expense, at end of year, we put the following transaction:

-   **Dr Depreciation Expense X**
-   **Cr Accumulated Depreciation (Liability) X**

<br />

### Disposals

A company may dispose of a non-current asset, on which they will earn either a profit or loss. The profit or loss is caluclated as:

+-----------------------------------+---------------+
| Cash received from disposal       | £X            |
|                                   |               |
| (less) carrying amount of the NCA | (£X)          |
+-----------------------------------+---------------+
| **Profit/(Loss) of Disposal**     | **£X/(£X)**   |
+-----------------------------------+---------------+

: {.bordered .sm tbl-colwidths="\[50,50\]"}

The double entries are simply: clear the NCA and accumulated depreciation, and add cash obtained from the disposal. All opposite entries are to the disposals account.

+------------------------------------------------------------+-----------------------------+
| 1\) Clear the non-current asset account.                   | Dr Disposals                |
|                                                            |                             |
|                                                            | Cr Non Current Assets       |
+------------------------------------------------------------+-----------------------------+
| 2\) Clear the accumulated depreciation account for the NCA | Cr Disposals                |
|                                                            |                             |
|                                                            | Dr Accumulated Depreciation |
+------------------------------------------------------------+-----------------------------+
| 3\) Record Proceeds                                        | Dr Cash                     |
|                                                            |                             |
...
Sometimes, you dispose of a NCA through exchanging it for a new product (ex. trade in iPhone). The disposal income/proceed is called a **parts exchange allowance**, and is simply the price of the new asset minus the cash paid for then new asset.