...
+--------------------+--------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------+
| **Audit Strategy** | Determines the scope, timing, and direction of the audit, and shapes the audit plan. | -   Understand the client and the environment.                                                               |
|                    |                                                                                      | -   Materiality threshold.                                                                                   |
|                    |                                                                                      | -   Risk assessment: potential areas more at risk of material misstatement.                                  |
|                    |                                                                                      | -   Nature, extent, timing of audit, direction of audit, who is supervising, and how review of work is done. |
+--------------------+--------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------+
| **Audit Plan**     | More detailed, shows how the overall strategy will be implemented.                   | -   More attention in planning to the high risk areas.                                                       |
|                    |                                                                                      | -   Potential problems and risks are identified early.                                                       |
|                    |                                                                                      | -   Organisation and management.                                                                             |
|                    |                                                                                      | -   Delegation of work to team members, supervision.                                                         |
|                    |                                                                                      | -   Reviews by more senior members are planned.                                                              |
+--------------------+--------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------+
...
Auditors do not want to give a wrong opinion, since shareholders/users depend on the auditor's opinion.

The risk of an audit (audit risk) giving a wrong opinion is calculated as follows:
...
|                                     | -   For example, an auditor could look at an invoice to confirm the cost of inventory.                                                                                       |
|                                     | -   Third party documentation (like invoices, certificates) are more reliable than internally created documents.                                                             |
|                                     | -   Inspection can provide evidence regarding the existence of things, the value of things, the rights and obligations (like in a contract), and the completeness of things. |
|                                     | -   **Remote Auditing Techniques**: For example, observing inventory counts through a live video, sharing documents electronically, and interviews via video call.           |
+-------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Observation**                     | -   Watching a process or procedure being performed.                                                                                                                         |
|                                     | -   For example, observe a firm's staff counting inventory.                                                                                                                  |
|                                     | -   Observation is useful for confirming a process is performed as described.                                                                                                |
|                                     | -   However, be aware that processes may not be the same when observed vs. unobserved.                                                                                       |
+-------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Inquiry and Confirmation**        | -   Regards asking staff (inquiry) or third-parties (confirmation).                                                                                                          |
|                                     | -   This is useful for understanding processes or obtaining explanations.                                                                                                    |
|                                     | -   Confirmation from third parties (banks, customers) is a strong form of evidence.                                                                                         |
|                                     | -   Be aware that oral responses are less reliable than written confirmation.                                                                                                |
+-------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Recalculation and Reperformance** | -   Checking the mathematical accuracy of documents and records. This is strong evidence as the auditor does it directly.                                                    |
|                                     | -   For example, the auditor recalculates the depreciation to confirm they match the accounts.                                                                               |
|                                     | -   Reperformance is similar to recalculation, but not with math. Basically, do the same thing that the firm did previously.                                                 |
+-------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Analytical Procedures**           | -   Like done in the planning stage.                                                                                                                                         |
|                                     | -   In the evidence stage, if inconsistency of expectations and figures are unacceptable, seek further evidence.                                                             |
+-------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Estimation Procedures**           | -   Some accounts require estimation, such as depreciation, allowance for receivables, and provisions. Since these are subjective, they are at risk of management bias.      |
...
: {.bordered .sm tbl-colwidths="\[20,80\]"}
